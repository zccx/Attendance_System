  ...
  <div>
    ...
    <div class="flex" style="margin-top: 50px">
      <div>
        <span>请假课程</span>
        <select>
          <option value="student" selected="selected" >工程实践</option>
          <option value="teacher">智能技术</option>
        </select>
      </div>
      <div>
        <span>请假日期</span>
      ...
      <div>
        <span>请假原因</span>
        <mt-field style="margin-top:20px;box-sizing: border-box;border-radius: 2px;border:1px solid #dedede;" type="textarea" rows="2"></mt-field>
      </div>
    ...
    <mt-button style="width: 150px;margin-top: 30px" type="primary">提交申请</mt-button>
  </div>
</template>
<script>
